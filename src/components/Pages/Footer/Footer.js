  ...
  return (
    <div className="bg-dark text-white">
      <Container className="mt-5 py-lg-5">
        <Row className="d-flex flex-wrap justify-content-center align-items-top">
          <Col xs={12} md={6}>
            <img
              src={logo}
              alt="logo"
              className="img-fluid pe-lg-5 my-3 mt-lg-0"
            />
            ...
            <h6 className="ms-4">© 20222 Drew Binsky</h6>
          </Col>
          <Col xs={4} md={2}>
